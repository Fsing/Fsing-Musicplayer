...
create table SongList(id int not null AUTO_INCREMENT PRIMARY KEY,name char(100) not null,author char(30) not null,createTime date not null,label char(30) not null,info varchar(1000) not null,icon char(50) not null,collectionQuantity int not null,
clickQuantity int not null,shareQuantity int not null);
...
create table SongListRelation(songlistID int null null,songID int not null);
...
insert into Song(id,name,source,singer,album,playQuantity,downloadQuantity,shareQuantity) values(1,'渡口','rtsp://192.168.8.79/music/dukou.mp3','蔡琴','民歌蔡琴',0,0,0);
...
insert into SongList(id,name,author,createTime,label,info,icon,collectionQuantity,clickQuantity,shareQuantity) 
values(5,'【经典】聼一首老歌，想念一段时光','Romantic丶Notes','2018-05-22 08:00:00','华语 怀旧 粤语','寂静的黄昏，总让人怀念，总是深深沦陷...那些个细数光阴在手中沉淀的日子，一去不复返...偶尔，我一个人站在黄昏的角落，代替你主持夕阳的葬礼...想着想着，痛凝重了时间，曳落了容颜..
.青春的羽翼...','5.jpg',77,10,0);
insert into SongList(id,name,author,createTime,label,info,icon,collectionQuantity,clickQuantity,shareQuantity) 
values(6,'就想傻傻看着你，谁叫我喜欢你','井屿森','2018-04-26 15:00:00','流行 华语 放松','  我喜欢你的眼睛，你的睫毛，你的微笑，和你在的每个瞬间，都很奇妙','6.jpg',160,20,13);
insert into SongList(id,name,author,createTime,label,info,icon,collectionQuantity,clickQuantity,shareQuantity) 
values(7,'【创造101】最全参赛曲目及其BGM','101','2018-04-21 18:00:00','R&B/Soul 华语 影视原声','《创造101》召集了101位偶像女团练习生，通过任务、训练、考核，让选手在明星导师训练下成长，循环人气投票、暂时淘汰的流程，最终通过人气投票选出11位女练习生，组成全新的偶像团体出道。
','7.jpg',123,12,21);
insert into SongList(id,name,author,createTime,label,info,icon,collectionQuantity,clickQuantity,shareQuantity) 
values(8,'华语电影台词对白｜念念有声','101','2018-04-01 14:00:00','影视原声','电影原声中除了收录歌曲、配乐，还会选择部分电影对白、旁白，这类台词对电影背景交代、情节推动、人物性格塑造往往有重要意义。例如《阿飞正传》中的“无脚鸟”、《倩女幽魂》里宁采臣与聂小倩的“只羡鸳鸯不羡仙”、
《花样年华》中慕云、丽珍的“如果有多一张船票”。而这些淫浸了光影魅力的词句段落，如今便成了电影粉丝的心头好。','8.jpg',112,2,0);
