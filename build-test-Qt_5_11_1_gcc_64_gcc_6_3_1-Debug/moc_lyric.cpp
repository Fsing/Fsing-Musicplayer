...
QT_MOC_LITERAL(3, 19, 11), // "timeChanged"
QT_MOC_LITERAL(4, 31, 8), // "getLyric"
QT_MOC_LITERAL(5, 40, 15), // "QList<QObject*>"
QT_MOC_LITERAL(6, 56, 4), // "path"
QT_MOC_LITERAL(7, 61, 4), // "time"
QT_MOC_LITERAL(8, 66, 4) // "text"

    },
    "Lyric\0textChanged\0\0timeChanged\0getLyric\0"
    "QList<QObject*>\0path\0time\0text"
};
...
void Lyric::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { QList<QObject*> _r = _t->getLyric((*reinterpret_cast< QString(*)>(_a[1])));
        ...
        {
            using _t = void (Lyric::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Lyric::textChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Lyric::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Lyric::timeChanged)) {
                *result = 1;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = _t->time(); break;
...
// SIGNAL 0
void Lyric::textChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Lyric::timeChanged()
{
